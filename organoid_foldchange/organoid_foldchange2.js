...
// console.log("averageFiveArray", averageFiveArray[0]);
// console.log("averageFiveArray", averageFiveArray[1]);
// console.log("averageFiveArray", averageFiveArray[2]);
// console.log("averageFiveArray", averageFiveArray[3]);
// console.log("averageFiveArray", averageFiveArray[4]);
...
for (i = 0; i < averageFiveArray.length; i++) {
    ...
    //put each flattened array(5 total) into fiveJoinedArray
    fiveJoinedArray.push(flattenArray);
    // console.log("fiveJoinedArray", fiveJoinedArray);

    var fold = fiveJoinedArray[i].map(function (value) {
        console.log("baseline", baselineNumberArray[i]);
        // console.log("value", value);
        return value/baselineNumberArray[i];
    })
